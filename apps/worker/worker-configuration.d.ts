/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 90d268a66df7f4a8309f2e90b7947b6b)
// Runtime types generated with workerd@1.20260815.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "production";
	SUPABASE_URL: "https://cjxpbvrlwxkcmqdqdqbu.supabase.co";
	ZITADEL_ISSUER: "https://ashterix-mkjzns.eu1.zitadel.cloud";
	ZITADEL_AUDIENCE: "390021886861484201";
	ALLOWED_ORIGIN: "http://localhost:5173,https://poetic-ping.ashterix.com";
	FROM_EMAIL: "Poetic Ping <onboarding@resend.dev>";
	FEEDBACK_EMAIL: "ashbladon@gmail.com";
	FEEDBACK_URL: "https://api.poetic-ping.ashterix.com/feedback";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_URL" | "ZITADEL_ISSUER" | "ZITADEL_AUDIENCE" | "ALLOWED_ORIGIN" | "FROM_EMAIL" | "FEEDBACK_EMAIL" | "FEEDBACK_URL">> {}
}
