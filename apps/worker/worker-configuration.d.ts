/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5b7d4d5fae148b307d758b7ad564b009)
...
interface __BaseEnv_Env {
	...
	ZITADEL_AUDIENCE: "your-worker-api-project-id";
	ALLOWED_ORIGIN: "http://localhost:5173,https://poetic-reminder.pages.dev";
	FROM_EMAIL: "Poetic Reminder <reminders@example.com>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_URL" | "ZITADEL_ISSUER" | "ZITADEL_AUDIENCE" | "ALLOWED_ORIGIN" | "FROM_EMAIL" | "SUPABASE_SERVICE_ROLE_KEY" | "RESEND_API_KEY">> {}
}
