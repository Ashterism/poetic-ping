  ...
  return (
    <section className="panel-grid">
      ...
      <form className="card form-card" onSubmit={add}>
        ...
        <label>About this poem (optional)<textarea name="explainer" rows={4} placeholder="A note on its context, themes or why it matters to you…" /></label>
